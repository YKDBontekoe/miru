...
- **Architecture**: Updated `AGENTS.md` and `README.md` to accurately reflect the correct project layer structures (e.g. `dependencies.py`, `use_cases/`, `entities.py`, `interfaces/` in productivity domain) and the `CodeRabbit` AI integration prompt discrepancies.
