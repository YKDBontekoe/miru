...
import { useProductivityData, RenderItemData } from '../../src/hooks/useProductivityData';
...
export default function ProductivityScreen() {
  ...
  const { fetchNotes, fetchTasks, fetchEvents, isLoading, deleteNote, deleteTask, toggleTask } =
