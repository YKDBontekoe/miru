...
describe('ChatInputBar', () => {
  it('renders correctly with placeholder', () => {
    const { getByPlaceholderText } = render(
      <ChatInputBar value="" onChangeText={() => {}} onSend={() => {}} isStreaming={false} />
    );
  ...
  it('calls onChangeText when typing', () => {
    ...
    const { getByPlaceholderText } = render(
      <ChatInputBar value="" onChangeText={mockOnChange} onSend={() => {}} isStreaming={false} />
    );
  ...
  it('disables send button when empty', () => {
    ...
    render(<ChatInputBar value="" onChangeText={() => {}} onSend={mockSend} isStreaming={false} />);
