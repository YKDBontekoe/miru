...
/// Wraps a widget with slide and fade-in animations.
///
/// This is typically used to animate chat messages as they enter the message list.
class AnimatedMessageItem extends StatefulWidget {
  /// The child widget to be animated.
  final Widget child;

  /// Creates an [AnimatedMessageItem].
