...
export const DESIGN_TOKENS = {
  colors: {
    ...
    borderFaint: HOME_CORE_COLORS.borderFaint,
    ...
    primarySoftText: HOME_CORE_COLORS.primarySoftText,
    primaryDark: HOME_CORE_COLORS.primaryDark,
    primaryDarker: HOME_CORE_COLORS.primaryDarker,
    accent: HOME_CORE_COLORS.accent,
    accentSoft: HOME_CORE_COLORS.accentSoft,
    deep: HOME_CORE_COLORS.deep,
    success: HOME_CORE_COLORS.success,
    warning: HOME_CORE_COLORS.warning,
    warningText: HOME_CORE_COLORS.warningText,
    destructive: '#B23A3A',
