...
export const HomeAgentChip = React.memo(function HomeAgentChip({
  ...
  return (
    ...
    >
      <View
        className="w-[26px] h-[26px] rounded-[13px] bg-primaryLight items-center
                   justify-center me-[7px]"
      >
      ...
      {agent.message_count > 0 && (
        <View className="bg-primary rounded-[9px] min-w-[18px] h-[18px] px-1.5 items-center justify-center ms-[7px]">
