...
export const RoomCard = React.memo(
  ({
    ...
    return (
      ...
      >
        <View style={[styles.avatar, { borderColor: C.surfaceHigh, backgroundColor: C.surface }]}>
            <View style={[StyleSheet.absoluteFill, { backgroundColor: C.primary, opacity: 0.15 }]} />
        ...
        <View style={styles.content}>
          ...
          <AppText variant="caption" style={[styles.previewText, { color: C.muted }]} numberOfLines={2}>
            {preview}
          </AppText>
        ...
        <View style={styles.rightContent}>
          {updatedLabel ? (
            <AppText variant="caption" style={[styles.dateText, { color: C.muted }]}>
              {updatedLabel}
            </AppText>
          ) : null}
          ...
          <View style={styles.actionRow}>
            {onTogglePin ? (
              <ScalePressable
                onPress={onTogglePin}
                style={[styles.pinButton, { backgroundColor: C.surface }]}
                accessibilityRole="button"
                accessibilityLabel={
                  pinned
