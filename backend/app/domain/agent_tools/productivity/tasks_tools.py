...
class ListTasksTool(BaseTool):
    ...
    @handle_tool_error(logger, "Error fetching tasks.")
...
class CreateTaskTool(BaseTool):
    ...
    @handle_tool_error(logger, "Error creating task.")
    async def _run(
        self,
        title: str,
...
class UpdateTaskTool(BaseTool):
    ...
    @handle_tool_error(logger, "Error updating task.", reraise=(TaskNotFoundError,))
    async def _run(
        self,
        task_id: UUID,
