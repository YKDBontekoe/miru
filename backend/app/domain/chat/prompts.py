...
MEMORY_PREFIX = """--- RELEVANT MEMORIES ---
{memories}
-------------------------
...
MULTI_AGENT_PROMPT = (
    ...
    "Refer to the most recent user message from the history to formulate your response. "
...
MULTI_AGENT_EXPECTED_OUTPUT = "A structured list of responses from the relevant agents."

SINGLE_AGENT_EXPECTED_OUTPUT = "A structured response from the agent."
