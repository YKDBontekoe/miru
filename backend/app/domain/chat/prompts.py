...
ROOM_SUMMARY_SYSTEM_PROMPT = (
    ...
    "Please generate a new, comprehensive but concise summary of the ENTIRE conversation "
    "(merging the current summary with the new messages). "
    "Focus on the main topics discussed, user preferences revealed, and any ongoing tasks or context "
    "the agents need to remember."
)
