...
class Task(SupabaseModel):
    ...
    recurrence_rule = fields.CharField(max_length=50, null=True)
    recurrence_end_date = fields.DatetimeField(null=True)
    calendar_event_id = fields.UUIDField(null=True)
...
class CalendarEvent(SupabaseModel):
    ...
    recurrence_rule = fields.CharField(max_length=50, null=True)
    recurrence_end_date = fields.DatetimeField(null=True)
    linked_task_id = fields.UUIDField(null=True)
    created_at = fields.DatetimeField(auto_now_add=True)
    updated_at = fields.DatetimeField(auto_now=True)
    deleted_at = fields.DatetimeField(null=True)
