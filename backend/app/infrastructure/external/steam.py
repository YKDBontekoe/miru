...
class SteamClient(SteamClientInterface):
    """Concrete implementation of the Steam API client."""
...
async def get_owned_games(
    ...
    client = SteamClient()
    return await client.get_owned_games(steam_id, include_appinfo, include_played_free_games)


async def resolve_vanity_url(vanityurl: str) -> str | None:
    client = SteamClient()
    return await client.resolve_vanity_url(vanityurl)
