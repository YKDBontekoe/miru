...
async def test_update_mood_success():
    ...
    llm.structured_completion.return_value = MoodResponse(mood="Happy")
...
async def test_update_mood_invalid_mood():
    ...
    llm.structured_completion.return_value = MoodResponse(mood="UnknownMood")
...
async def test_generate_agent_profile():
    ...
    llm.structured_completion.return_value = mock_response
...
async def test_generate_agent_profile_chaos_timeout():
    ...
    llm.structured_completion.side_effect = TimeoutError("LLM API Timeout")
