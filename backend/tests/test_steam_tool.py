...
@pytest.mark.asyncio
@patch("app.infrastructure.external.steam.SteamClient.get_player_summaries", new_callable=AsyncMock)
...
@pytest.mark.asyncio
@patch("app.infrastructure.external.steam.SteamClient.get_owned_games", new_callable=AsyncMock)
