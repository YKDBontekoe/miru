-- Migration: remove_avatar_url
-- Generated: 2026-03-13T13:16:31.226994+00:00
-- Type: incremental

-- Schema changes --------------------------------------------------------

-- Removed column 'avatar_url' from agents
ALTER TABLE public.agents DROP COLUMN IF EXISTS "avatar_url";
-- Removed column 'avatar_url' from agent_templates
ALTER TABLE public.agent_templates DROP COLUMN IF EXISTS "avatar_url";
